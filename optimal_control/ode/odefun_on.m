...
lambda13 = y(7:9);
lambda46 = y(10:12);
eta = 1/(2*rho^2) * (-4*v'*lambda13 + 3*v'*M2*lambda46 - lambda46'*lambda46 ...
                     + 5*v'*M2*lambda46 - r'*M2*lambda13 + 2*r'*M2*M2*lambda46 ...
                     - 4*r'*M1*M1*r - 3*r'*M1*M2*v + 8*r'*M1*lambda46 ...
                     - 4*v'*M1*v - r'*M2*M1*v - r'*M2*M1*r - r'*M2*M2*v ...
                     - r'*M2*M2*v + r'*M2*lambda46);
