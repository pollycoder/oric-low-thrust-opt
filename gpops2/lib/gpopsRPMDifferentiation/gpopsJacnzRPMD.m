function jacnz = gpopsJacnzRPMD(Z, probinfo)
        ...
        if varnum <= numstatep+numcontrolp;
            ...
            for dynamicscount = 1:numstatep;
                ...
                if dynamicsgrdref ~= 0;
                    ...
                    % assign values
                    jacnz(jacindex) = -tdiff*contgrdp.dynamicsgrd(:,dynamicsgrdref);
                end
            end
    ...
    if phasetimeflag;
        ...
        for dynamicscount = 1:numstatep;
            ...
            if dynamicsgrdref ~= 0;
                ...
                jacindex = jacmarkers:jacmarkere;
                % assign values
                jacnz(jacindex) = contfunp.dynamics(:,dynamicscount)/2 - tdiff*dtdt0.*contgrdp.dynamicsgrd(:,dynamicsgrdref);
                ...
                jacindex = jacmarkers:jacmarkere;
                % assign values
                jacnz(jacindex) = -contfunp.dynamics(:,dynamicscount)/2 - tdiff*dtdtf.*contgrdp.dynamicsgrd(:,dynamicsgrdref);
            else
                % derivative respect to t0
                jacmarkers = jacmarkere + 1;
                jacmarkere = jacmarkere + numnodesp;
