function [meshaccepted, newmesh, maxerror] = gpopsMeshAnalysisHP(result, setup)
  ...
  if phasemaxerror <= mesh.tolerance;
    ...
    for segcount = 1:numseg;
      ...
      if segmaxerror > mesh.tolerance;
        ...
        % modify segment
        [segcolpoints, segfraction] = gpopsMeshModifySegmentHP(segcount, mesh, segcolpoints, segfraction, segmaxerror, k);
      end
      % save new mesh
      if segcount == 1;
