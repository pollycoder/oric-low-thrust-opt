function hesnz = gpopsHesnzRPMI(sig, lam, Z, probinfo)
...
% constraints
ocpmult = gpopsMultipliersRPMI(lam, probinfo);
...
% get first derivatives of the optimal control problem continuous function
...
% get second derivatives of the optimal control problem
if probinfo.analyticflag;
...
for phasecount = 1:numphase;
    ...
    % scale dynamicsmult for integration
    contmultp.defectmult = full(probinfo.collocation(phasecount).Emat'*contmultp.defectmult);
