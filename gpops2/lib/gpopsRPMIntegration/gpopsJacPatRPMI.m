function [jacnonlinpat, probinfo] = gpopsJacPatRPMI(probinfo)

% gpopsJacPatRPMI
% this function finds the sparsity pattern of the  Jacobian
...
probinfo.jaclinMat = sparse(jaclinmat(:,1), jaclinmat(:,2), jaclinmat(:,3), probinfo.nlpnumcon, probinfo.nlpnumvar);